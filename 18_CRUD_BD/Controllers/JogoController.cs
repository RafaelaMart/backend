...
namespace _18_CRUD_BD.Controllers
{
    public class JogoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("JogoId,Nome,Descrição,Imagem,Ativo")] Jogo jogo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JogoId,Nome,Descrição,Imagem,Ativo")] Jogo jogo)
        {
            if (id != jogo.JogoId)
            {
                return NotFound();
