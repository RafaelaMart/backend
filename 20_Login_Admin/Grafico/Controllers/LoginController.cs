...
namespace App.Controllers
{
    public class LoginController : Controller
    {
        ...
        {
            // Buscando no banco de dados o se há um usuário igual aos dadosrecebidos no form
            Usuario usuarioAutenticado = _context.Usuarios.FirstOrDefault(u =>
            u.Login == usuario.Login && u.Senha == usuario.Senha);
            if (usuarioAutenticado != null)
            {
                HttpContext.Session.SetInt32("UsuarioId",
