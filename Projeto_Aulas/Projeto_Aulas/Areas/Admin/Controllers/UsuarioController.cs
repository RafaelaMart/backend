...
namespace Grafico.Areas_Admin_Controllers
{
    ...
    public class UsuarioController : Controller
    {
        ...
        // GET: Usuario
        public IActionResult Index(string botao,string? txtFiltro, string? sel0rdenacao, int pagina =1)
        {
           int pageSize = 5; //Numero de intens
